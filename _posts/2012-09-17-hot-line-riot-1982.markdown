...
An official number is eventually established, but under different house rules. Only 5 people are allowed to talk simultaneously and then only [5 minutes at a time](http://www.blay.se/hetalinjen.html). Presumable the police also have a ear on the wire on Friday evenings. In this way, a social need can be fulfilled without for that matter having unforseen events occuring in the city on the weekends.
