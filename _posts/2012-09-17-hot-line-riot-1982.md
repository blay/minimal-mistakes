...
An official number is eventually established, but under different house rules. Only 5 people are allowed to talk simultaneously and then only [5 minutes at a time](2012-08-22-hans-magnus-enzensberger-om-heta-linjen-upploppet-1982.html). Presumable the police also have a ear on the wire on Friday evenings. In this way, a social need can be fulfilled without for that matter having unforseen events occuring in the city on the weekends.
